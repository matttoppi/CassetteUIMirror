...
class ProfilePageOld extends StatefulWidget {
  ...
  const ProfilePageOld({Key? key, this.code, this.error}) : super(key: key);

  @override
  _ProfilePageOldState createState() => _ProfilePageOldState();
}

class _ProfilePageOldState extends State<ProfilePageOld> with AuthRequiredState<ProfilePageOld>, WidgetsBindingObserver {
